...
from .... import LOGGER, config_dict, download_dict_lock, download_dict, non_queued_dl, queue_dict_lock
from ...telegram_helper.message_utils import sendMessage, sendStatusMessage
from ...ext_utils.bot_utils import get_mega_link_type, async_to_sync, sync_to_async
...
async def add_mega_download(mega_link, path, listener, name):
    ...
    api = MegaApi(None, None, None, 'SyntaxRealm')
    folder_api = None
    ...
    if get_mega_link_type(mega_link) == "file":
        ...
        folder_api = MegaApi(None, None, None, 'SyntaxRealm')
