...
2. **Sample File :** Check [syntax_minimal.py](https://github.com/IamElite/D2/blob/arnv1/bot/helper/themes/syntax_minimal.py)

---

#### ***Step 1:*** Open the Blank Editor and Paste the Codes of syntax_minimal.py and name it `syntax_custom.py`
You can give the `custom` as your choice, like `syntax_futuristic.py`, etc
...
- _Things to Remember while Editing :_
  ...
  - Don't Change the Class name SyntaXStyle
  - Don't Use f-string like `f"{var}"`
***Sample Editing :***
```python
class SyntaXStyle: # Don't Change This
    ST_BN1_NAME = '{sb1n}'
...
```python
AVL_THEMES = {"minimal": syntax_minimal, "emoji": syntax_emoji, "futuristic": syntax_futuristic} # You can add More ...
