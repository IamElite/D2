...
from .. import bot, LOGGER, bot_cache, bot_name
from ..helper.telegram_helper.button_build import ButtonMaker
from ..helper.ext_utils.bot_utils import new_thread, new_task
from ..helper.telegram_helper.message_utils import sendMessage, editMessage, deleteMessage, sendFile, sendCustomMsg
...
<i>Send /stop to Stop Process</i>""")
 ...
 <i>Send /stop to Stop Process</i>""")
    ...
    try:
        ...
        await pyro_client.send_message("self", f"⌬ <b><u>Pyrogram Session Generated :</u></b>\n\n<code>{session_string}</code>\n\n<b>Via <a href='https://telegram.me/SyntaxRealm'>sʏɴᴛᴀx ʀᴇᴀʟᴍ</a> [ @SyntaxRealm ]</b>", disable_web_page_preview=True)
        await pyro_client.disconnect()
