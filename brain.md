...
**Followup (user: values dikhao):** metadata_menu buttons pe current VALUE inline (`✅ Title: My Movie` / `❌ Author`, trun 20) — custom buttons bhi; remove/set turant button-label pe reflect.  
